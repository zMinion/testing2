 ...
 * @access public
 */
if ( !class_exists('nggAdmin') ) { //if added by zMinion
class nggAdmin{
     ...
     * @return void
     */
	static function import_gallery($galleryfolder, $gallery_id=NULL, $create_thumbs = true) { //modified by zMinion	
		...
		if ( $create_thumbs ) //IF added by zMinion
...
if ( !function_exists('ngg_refreshSavedSettings') ) { //if added by zMinion
